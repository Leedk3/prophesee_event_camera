    ...
    image_tracking_(nh)
{
  ...
  event_sub_ = nh_.subscribe("/prophesee/camera/cd_events_buffer", 1, &Renderer::eventsCallback, this);
  camera_info_sub_ = nh_.subscribe("/prophesee/camera/camera_info", 1, &Renderer::cameraInfoCallback, this);
...
void Renderer::eventsCallback(const prophesee_event_msgs::EventArray::ConstPtr& msg)
{
